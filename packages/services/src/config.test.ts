...
import { DEFAULT_CONFIG, ensureConfigDirs, loadConfig, parseConfig, saveConfig } from './config.js';
...
describe('ensureConfigDirs', () => {
  it('creates the whole tree and is safe to repeat', async () => {
    ...
    for (const target of [paths.dashboardsDir, paths.vibesDir, paths.pluginsDir, paths.logDir]) {
